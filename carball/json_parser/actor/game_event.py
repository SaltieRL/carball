...
class GameEventHandler(BaseActorHandler):
    ...
    def can_handle(cls, actor: dict) -> bool:
        return actor['ClassName'] is not None and actor['ClassName'].startswith('TAGame.GameEvent_Soccar_TA') or actor['ClassName'].startswith('TAGame.GameEvent_GodBall_TA')
